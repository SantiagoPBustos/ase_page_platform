...
<html lang="es">
    ...
    <article class="container-ingresos">
        <section>
            <h1>EGRESOS</h1>
            <a href="addEgreso.php" class="a-button">AGREGAR EGRESO</a>
        </section>
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    ...
                    <?php
                        ...
                        $sql=$conexion->query(" SELECT * FROM egresos JOIN accounts WHERE id_account=branch AND branch=$number ORDER BY id_egreso DESC");
                    ...
                    <tr>
                        ...
                        <td><?= $datos->date ?></td>
                        <td>
                            <a href="editEgreso.php?id=<?=$datos->id_egreso?>"><img src="../../../imgs/edit.png"></a>
                        </td>
                        <td>
                            <form action="controller_deleteEgreso.php?id=<?=$datos->id_egreso?>" method="post">
