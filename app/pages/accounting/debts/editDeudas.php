<?php
    ...
    $id=$_GET["id"];
    $sql=$conexion->query("SELECT * FROM deudas WHERE id_deuda=$id ");
?>
...
<body class="bg-gray">
    ...
    <form action="controller_editDeudas.php" method="post" class="addIngreso">
        <?php
        ...
        <input name="adeudado" type="text" placeholder="Adeudado" value="<?= $datos->adeudado ?>">
        <?php } ?> 
        <input name="btn-edit-deuda" class="button-input" type="submit" value="GUARDAR">
    </form>
